...
async function handleCategoryChange() {
  ...
  if(selectedCategory === 'Phones'){
        try {
      const response = await fetch('http://localhost:3002/categories/phones', {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json'
  ...
  if (selectedCategory === "TVs"){
    try {
      const response = await fetch('http://localhost:3002/categories/tvs', {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json'
  ...
  if(selectedCategory === 'Watches'){
    try {
      const response = await fetch('http://localhost:3002/categories/watches', {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json'
  ...
  if(selectedCategory === 'Desktops'){
    try {
      const response = await fetch('http://localhost:3002/categories/desktops', {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json'
  ...
  if(selectedCategory === 'Laptops'){
    try {
      const response = await fetch('http://localhost:3002/categories/laptops', {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json'
  ...
  if(selectedCategory === 'Tablets'){
    try {
      const response = await fetch('http://localhost:3002/categories/tablets', {
        method: 'GET',
        credentials: 'include',
        headers: {
          'Content-type': 'application/json'
