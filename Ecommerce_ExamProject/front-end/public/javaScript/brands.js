...
async function handleBrandChange() {
  ...
  if (selectedBrand === "Apple") {
    try {
      const response = await fetch("/api/brands/apple", {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-type": "application/json",
  ...
  if (selectedBrand === "Samsung") {
    try {
      const response = await fetch("/api/brands/samsung", {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-type": "application/json",
  ...
  if (selectedBrand === "Xiaomi") {
    try {
      const response = await fetch("/api/brands/xiaomi", {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-type": "application/json",
  ...
  if (selectedBrand === "MXQ") {
    try {
      const response = await fetch("/api/brands/mxq", {
        method: "GET",
        credentials: "include",
        headers: {
          "Content-type": "application/json",
